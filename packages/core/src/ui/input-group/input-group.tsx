...
import { Button } from '@repo/core/src/ui/button'
import { Input } from '@repo/core/src/ui/input'
import { Textarea } from '@repo/core/src/ui/textarea'
...
const inputGroupAddonVariants = cva(`
	...
	text-select-foreground select-none
...
function InputGroupAddon({
	...
	return (
		// Клик по addon только перебрасывает фокус во вложенный input: интерактивные
		// элементы внутри (кнопки) остаются доступны с клавиатуры сами по себе.
...
function InputGroupText({ className, ...props }: React.ComponentProps<'span'>) {
	return <span className={cn(`
		flex items-center gap-2 text-sm text-select-foreground
