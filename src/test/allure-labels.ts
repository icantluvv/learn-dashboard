...
const featureByPath = [
	{
		feature: 'Подтверждение email',
		includes: ['/app/account/email-change/confirm/', '/app/registration/email-confirmed/'],
	},
	{ feature: 'Смена email', includes: ['/app/account/email-change/'] },
	{
		feature: 'Семейная команда',
		includes: [
			'/app/account/_components/account-team-tab/',
			'/app/family/',
			'/app/_lib/captain-without-team.unit.test.ts',
			'/src/lib/invite-errors.unit.test.ts',
		],
	},
	{
		feature: 'Рейтинги',
		includes: [
			'/app/account/_components/account-ratings-tab/',
			'/app/catalog/_components/task-rating/',
			'/app/catalog/_lib/task-rating/',
		],
	},
	{
		feature: 'Региональный кабинет',
		includes: ['/app/account/_components/account-regional-tabs/'],
	},
